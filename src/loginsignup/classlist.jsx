...
export default function ClassList() {
  ...
  let dataArray2 = [];
  const getData = async () => {
    const querySnapshot = await getDocs(collection(db, "classform"));
          ...
          <TableBody>
            {dataArray.map((e) => (
              ...
              >
                ...
                <TableCell align="right">{e.data.firstName}</TableCell>
                <TableCell align="right">{e.data.lastName}</TableCell>
                <TableCell align="right">{e.data.Email}</TableCell>
                <TableCell align="right">{e.data.className}</TableCell>
                <TableCell align="right">{e.data.qualification}</TableCell>
                <TableCell align="right">{e.data.phoneNo}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
